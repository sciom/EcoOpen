...
def save_pipeline_results_to_csv(results: List[dict], csv_path: str):
    # Define columns to match your ecoopen_output.csv as closely as possible
    columns = [
    ...
    with open(csv_path, mode="w", newline="") as f:
        ...
        for i, r in enumerate(results, 1):
            ...
            row = {
                ...
                "is_oa": None,  # Not directly available, could be added if needed
                "downloaded": bool(r.get("pdf_path")),
                "path": r.get("pdf_path"),
                "pdf_content_length": r.get("pdf_size"),
                "data_links": safe_str(extraction.get("data_urls")),
                "downloaded_data_files": None,  # Not implemented in pipeline
