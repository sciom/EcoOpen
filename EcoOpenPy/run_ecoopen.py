import asyncio
from ecoopen_core import EcoOpen

async def main():
    # Sample DOIs: 100 real ecological articles provided by user
    sample_dois = [
    ...
    eco = EcoOpen()
    df = await eco.process_dois(sample_dois)
